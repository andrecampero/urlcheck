...
<script type="text/javascript" src="<?php echo e(URL::to('js/jquery-ui.min.js')); ?>"></script>
<script>
  $.widget.bridge('uibutton', $.ui.button);
</script>
<script type="text/javascript" src="<?php echo e(URL::to('js/jquery.doubleScroll.js')); ?>"></script>
<script>
	setInterval(function() {
		...
		// Send Post Request
		$.ajax({
			url: '<?php echo e(route("get.protocols")); ?>',
			type: 'GET',
			//data: {de: de, ate: ate}
		})
		.done(function (data) {
	...
	$('#protocol-table').DataTable({
		...
		aaSorting: [[0, "desc"]],
		ajax: '<?php echo e(route("get.protocols")); ?>',
		columns: [
